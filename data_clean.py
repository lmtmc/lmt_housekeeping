...
thermety_data = load_all_data('thermetry')
# dilutionFridge_data = load_all_data('dilutionFridge')
# cryocmp_data = load_all_data('cryocmp')
# rsfend_data = load_all_data('rsfend')
print(thermety_data[1], thermety_data[2])
# print(dilutionFridge_data[1], dilutionFridge_data[2])
# print(cryocmp_data[1], cryocmp_data[2])
# print(rsfend_data[1], rsfend_data[2])

# data = process_file('/home/lmt/data_lmt/thermetry/thermetry_2022-06-21_000001_00_1655834695.nc')
